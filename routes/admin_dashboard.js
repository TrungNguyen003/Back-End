...
router.get('/admin/dashboard/orders-revenue', isAuthenticated, isAdmin, async (req, res) => {
  try {
...
router.get('/admin/dashboard/cancelled-orders', isAuthenticated, isAdmin, async (req, res) => {
  try {
...
router.get('/admin/dashboard/combined-stats', isAuthenticated, isAdmin, async (req, res) => {
  try {
