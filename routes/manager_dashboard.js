...
router.get('/manager/dashboard/orders-revenue', isAuthenticated, isManager, async (req, res) => {
  try {
...
router.get('/manager/dashboard/stats', isAuthenticated, isManager, async (req, res) => {
  try {
    // Tổng số đơn hàng
...
router.get('/manager/dashboard/cancelled-orders', isAuthenticated, isManager, async (req, res) => {
  try {
...
router.get('/manager/dashboard/combined-stats', isAuthenticated, isManager, async (req, res) => {
  try {
